...
/**
 * 重写linkedList类 测试linkedList的实现机制
 *
 * @param <E>
 */
public class MyLinkedList<E>
        extends AbstractSequentialList<E>
        implements List<E>, Deque<E>, Cloneable, RandomAccess, java.io.Serializable {
     ...
     */
    public E unlinkFirst(MyLinkedList.Node<E> f) {
     ...
     */
    public E unlinkLast(MyLinkedList.Node<E> l) {
    ...
    public class ListItr implements ListIterator<E> {
        public MyLinkedList.Node<E> lastReturned;
    ...
    public class DescendingIterator implements Iterator<E> {
        public final MyLinkedList.ListItr itr = new MyLinkedList.ListItr(size());
    ...
    public MyLinkedList<E> superClone() {
        try {
     ...
     * {@link java.util.Spliterator#ORDERED}.  Overriding implementations should document
     * the reporting of additional characteristic values.
     *
     * @return a {@code Spliterator} over the elements in this list
     * @implNote The {@code Spliterator} additionally reports {@link java.util.Spliterator#SUBSIZED}
     * and implements {@code trySplit} to permit limited parallelism..
     * @since 1.8
     */
    @Override
    public java.util.Spliterator<E> spliterator() {
        return new MyLinkedList.LLSpliterator<E>(this, -1, 0);
    }
